...
echo -e  "############################################"
echo -e  "# This script creates standard analysis and output directories"
echo -e  "# for a new project. It also creates a README file with the"
echo -e  "# project name and a brief description of the project."
echo -e  "# Then it unzips the raw data provided by the client."
